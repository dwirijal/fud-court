                           ...
                           <Table>
                            ...
                            <TableBody>
                                ...
                                <TableRow key={coin.symbol}>
                                    ...
                                    <TableCell className="text-right font-mono text-sm">{formatCurrency(coin.current_price, 'usd')}</TableCell>
                                    <TableCell className="text-right font-mono text-sm">{formatCurrency(coin.ath, 'usd')}</TableCell>
