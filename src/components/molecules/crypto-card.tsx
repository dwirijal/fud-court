...
export function CryptoCard({ data, className }: { data: CryptoData, className?: string }) {
  ...
  return (
    <Card className={cn("relative flex flex-col justify-between h-full overflow-hidden transition-all duration-normal hover:-translate-y-px hover:shadow-lg focus-ring p-3", className)}>
