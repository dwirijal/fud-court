...
const cryptoLogos = [
  ...
  'https://cryptologos.cc/logos/bnb-bnb-logo.png?v=032',
  'https://cryptologos.cc/logos/solana-sol-logo.png?v=032',
  'https://cryptologos.cc/logos/lido-dao-ldo-logo.png?v=032',
  'https://cryptologos.cc/logos/usd-coin-usdc-logo.png?v=032',
  'https://cryptologos.cc/logos/xrp-xrp-logo.png?v=032',
  'https://cryptologos.cc/logos/dogecoin-doge-logo.png?v=032',
  'https://cryptologos.cc/logos/toncoin-ton-logo.png?v=032',
  'https://cryptologos.cc/logos/cardano-ada-logo.png?v=032',
  'https://cryptologos.cc/logos/shiba-inu-shib-logo.png?v=032',
  'https://cryptologos.cc/logos/avalanche-avax-logo.png?v=032',
  'https://cryptologos.cc/logos/chainlink-link-logo.png?v=032',
  'https://cryptologos.cc/logos/tron-trx-logo.png?v=032',
  'https://cryptologos.cc/logos/polkadot-new-dot-logo.png?v=032',
  'https://cryptologos.cc/logos/bitcoin-cash-bch-logo.png?v=032',
  'https://cryptologos.cc/logos/near-protocol-near-logo.png?v=032',
  'https://cryptologos.cc/logos/uniswap-uni-logo.png?v=032',
  'https://cryptologos.cc/logos/litecoin-ltc-logo.png?v=032',
];
